...
@interface WMHTTPURLConnectionDelegate ()

@property (nonatomic, strong) WMHTTPURLResponse *response;

@end

@implementation WMHTTPURLConnectionDelegate
...
- (id)initWithDelegate:(id)delegate
{
    ...
    if (self)
    {
        ...
        self.response = [[WMHTTPURLResponse alloc] init];
    }
